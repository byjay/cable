...
export interface CableData {
    ...
    type: string;
    od: number;
    system?: string; // New: Cable System Group
    fromNode?: string; // New: From Node for sorting
    toNode?: string; // New: To Node for routing
    checkNode?: string; // New: Check Node for routing waypoints
    calculatedPath?: string[]; // New: Result of routing
    color?: string;
}
