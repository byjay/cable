...
interface ThreeSceneWithCableRouteProps {
  nodes: Node[];
  cables: any[];
...
const ThreeSceneWithCableRoute: React.FC<ThreeSceneWithCableRouteProps> = ({ 
  nodes, 
  cables,
  deckHeights, 
  routingService,
...
export default ThreeSceneWithCableRoute;
