...
import { SystemResult } from '../../services/tray/types';
import { ZoomIn, ZoomOut, Maximize, Calculator, CheckCircle2, AlertTriangle, List, Grid, Download, ArrowRight } from 'lucide-react';
                                    ...
                                    return (
                                        <g key={`cables-${idx}`} onClick={(e) => e.stopPropagation()}>
                                            {tier.cables.map((c) => {
                                                ...
                                                // Theoretically c.y >= c.od/2. If not (due to float precision), clamp it.
                                        ...
                                        {tier.cables.map(c => {
                                            ...
                                            return (
                                                <tr
                                                    ...
                                                    className={`cursor-pointer transition-colors border-b border-slate-50 last:border-0 ${isHighlighted
